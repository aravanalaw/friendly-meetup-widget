...
import tabPersonalInjury from "@/assets/tab-personal-injury.png";
import tabWorkersCompensation from "@/assets/tab-workers-compensation.png";
import tabCarAccident from "@/assets/tab-car-accident.png";
import tabWrongfulDeath from "@/assets/tab-wrongful-death.png";
import tabPedestrianAccident from "@/assets/tab-pedestrian-accident.png";
import tabMotorcycleAccident from "@/assets/tab-motorcycle-accident.png";
...
const TABS: Tab[] = [
  {
    ...
    image: tabPersonalInjury,
    imageAlt: "Client with an arm injury consulting a personal injury attorney",
    paragraphs: [
  ...
  },
  {
    ...
    image: tabWorkersCompensation,
    imageAlt: "Injured worker filing a workers compensation claim",
    paragraphs: [
  ...
  },
  {
    ...
    image: tabCarAccident,
    imageAlt: "Damaged vehicles after a car accident",
    paragraphs: [
  ...
  },
  {
    ...
    image: tabWrongfulDeath,
    imageAlt: "Family consulting an attorney about a wrongful death claim",
    paragraphs: [
  ...
  },
  {
    ...
    image: tabPedestrianAccident,
    imageAlt: "Pedestrian crossing where an accident occurred",
    paragraphs: [
  ...
  },
  {
    ...
    image: tabMotorcycleAccident,
    imageAlt: "Motorcycle on the road after an accident",
    paragraphs: [
    ...
    <section className="container-site py-20 md:py-28">
      ...
      <div className="mt-14 grid gap-10 lg:grid-cols-[minmax(0,360px)_1fr]">
        ...
        <Reveal variant="fade" delay={150}>
          ...
          >
            {/* key remounts on tab switch to replay the fade, like the
                WordPress "animated fadeIn" panes */}
            <div key={tab.id} className="tab-fade">
